...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  void initState() {
    ...
    _chatKitController.messages = [
      ...
      ChatMessage(user: dat, id: 1, time: DateTime.parse('2022-06-10T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-10T03:44:08.000000Z'),text: 'alo alo'),
      ...
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-09T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-09T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: dat, id: 1, time: DateTime.parse('2022-06-09T03:44:08.000000Z'),text: 'alo alo2222'),
      ChatMessage(user: dat, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: viet, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: viet, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: viet, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: 'alo alo'),
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),text: '123'),
      ChatMessage(
          user: nam,
          id: 1,
      ...
      ChatMessage(user: nam, id: 1, time: DateTime.parse('2022-06-08T03:44:08.000000Z'),imageUrls: [
